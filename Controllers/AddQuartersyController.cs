...
{
    public class AddQuartersyController : Controller
    {
        private readonly ILogger<AddQuartersyController> _logger;

        public AddQuartersyController(ILogger<AddQuartersyController> logger)
        {
            _logger = logger;
        }
